...
class msInformMeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('msinformme_item_err_ns');
        }
...
return 'msInformMeItemUpdateProcessor';
